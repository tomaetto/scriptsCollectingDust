...
class TetrisGameLogic:
    ...
    def new_piece(self):
        ...
        # Return a new TetrisShape
        return TetrisShapes(self.width // 2, 0, shape)

    def valid_move(self, piece, x, y, rotation):

        """This will check if the pieces, move is valid to the given position."""
    ...
    def update(self):
        ...
        """If the game is not gameOver. Move the shapes down one cell, or yaxis row to collide the ground."""
...
def main():
    ...
    pygame.display.set_caption('KnockoffTetris')
    ...
    game = TetrisGameLogic(WIDTH // GRID_SIZE, HEIGHT // GRID_SIZE)
...
# knockOffTetris By Matthew Royeca.